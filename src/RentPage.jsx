  ...
  return (
    <Box>
      <Box
        ...
        component="img"
        src="https://media.istockphoto.com/id/1303750117/photo/modern-real-estate-front-exterior-blue-and-white-color-scheme-with-landscaping.webp?s=2048x2048&w=is&k=20&c=Gw-0E5dFp0mvBNiWRZScaxQWQkZubN9Jg7kCvzJ9B28="
        alt="imagebanner"
      ></Box>
      <Box
        sx={{
          position: "relative",
          backgroundColor: "rgba(50,66,85, 0.5)",
          width: "relative",
          height: "350px",
          top: "20px",
        }}
